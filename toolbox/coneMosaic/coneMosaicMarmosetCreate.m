...
theConeMosaic = coneMosaicHex(resamplingFactor, ...
    ...
    'macular', marmosetMacularPigment(thePhotopigment.wave), ...
...
function theMacularPigment = marmosetMacularPigment(wavelength)
% Generate marmoset-specific macular pigment  (absent, so zero density)
fprintf(2, 'Warning. Macular density = 0');
